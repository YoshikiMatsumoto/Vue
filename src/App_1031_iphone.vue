...
export default {
  ...
  data() {
    return {
      ...
      palletHeaders: [
        ...
        { text: '作業者', value: 'worker', align: 'center' },
        { text: '履歴', value: 'history', align: 'center' },
      ],
      tab: {
        SA: 0,
        SB: 0,
  ...
  methods: {
    ...
    createLineTasks(line) {
      return [
        { line, taskName: 'ストロー', remainingTime: 630, originalTime: 630, completed: false, thresholds: [20, 80], worker: '', history: [] },
        { line, taskName: 'メルト1', remainingTime: 8100, originalTime: 8100, completed: false, thresholds: [20, 80], worker: '', history: [] },
        { line, taskName: 'メルト2', remainingTime: 8100, originalTime: 8100, completed: false, thresholds: [20, 80], worker: '', history: [] },
        { line, taskName: 'メルト3', remainingTime: 8100, originalTime: 8100, completed: false, thresholds: [20, 80], worker: '', history: [] },
